...
class Role(db.Model):
    ...
    PERMISSION_FIELDS = [
        ...
        "can_view_guests",
        "can_moderate_staff",
        "can_maintain_mastodon_accounts",
    ]
    ...
    PERMISSION_LABELS = {
        ...
        "can_maintain_mastodon_accounts": "Mastodon account maintenance (2FA, password, email)",
    }
    ...
    can_maintain_mastodon_accounts = db.Column(db.Boolean, default=False)
...
DEFAULT_ROLES = [
    {"name": "super_admin", "display_name": "Super Admin", "level": 4, "is_builtin": True,
     ...
     "can_moderate": True, "can_use_ai": True, "can_view_guests": True, "can_moderate_staff": True, "can_maintain_mastodon_accounts": True},
    ...
    {"name": "operator", "display_name": "Operator", "level": 2, "is_builtin": True,
     ...
     "can_moderate": False, "can_use_ai": False, "can_view_guests": True, "can_moderate_staff": False, "can_maintain_mastodon_accounts": False},
    ...
    {"name": "moderator", "display_name": "Moderator", "level": 2, "is_builtin": True,
     ...
     "can_restart_unifi": False, "can_view_audit_log": False, "can_view_services": False, "can_edit_services": False,
     "can_view_unifi": False, "can_view_ipmi": False, "can_manage_ipmi": False,
     "can_moderate": True, "can_use_ai": False, "can_view_guests": False, "can_moderate_staff": False, "can_maintain_mastodon_accounts": False},
]
...
class User(UserMixin, db.Model):
    ...
    @property
    def can_maintain_mastodon_accounts(self):
        if self.is_super_admin:
            return True
        return self.role_obj.can_maintain_mastodon_accounts if self.role_obj else False
