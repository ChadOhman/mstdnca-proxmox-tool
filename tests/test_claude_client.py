...
class TestClaudeClient:
    ...
    def test_init_stores_params(self):
        client = ClaudeClient("sk-test", model="claude-haiku-4-5-20251001", max_tokens=1024)
    ...
    def test_test_connection_failure(self):
        client = ClaudeClient("sk-invalid")
        client._client = MagicMock()
...
class TestCachedClient:
    ...
    def test_returns_client_when_configured(self, app):
        with app.app_context():
            ...
            from models import Setting
            Setting.set("ai_enabled", "true")
            Setting.set("ai_api_key", encrypt("sk-ant-test"))
